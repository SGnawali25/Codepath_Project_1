...
function CardLayout() {
  ...
  const [cardLayoutClass, setCardLayoutClass] = useState('cardLayoutFirst')
  ...
  return (
    <div className="App">
      <div className='left-panel'>
        ...
        <h1 className='author-title'>{artistData && artistData.name !== "" ? "Artist Name: " + artistData.name : "" }</h1>
        <h2>Show By</h2>
        <p>Number of Songs per album</p>
      ...
      <div className='right-panel'>
        {artistData && <div className='container stats-container'>
          <div className="stat-card">{artistData ? "Artist Rating : " + artistData.popularity : ""}</div>
          <div className="stat-card">{albums.length !== 0 ? "Album Size : " + initialAlbumsData.length : ""}</div>
