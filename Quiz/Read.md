...
This web app: **User can test their basic computer knowledge by playing quiz**
...
- [ ] Clicking on a card shows the answer to the question.
- [ ] Clicking on a next button asks you next question.
- [ ]  list of card pairs is created.
- [ ] The title of the card set and some information about it are displayed.
